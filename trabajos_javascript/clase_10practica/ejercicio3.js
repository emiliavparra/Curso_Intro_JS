...
// 1.	Crea una constante llamada EDAD_MINIMA y otra llamada EDAD_MAXIMA, a las cuales 
// les asignamos los valores numéricos 18 y 99 respectivamente.
...
// Declaro las variables con const para que no puedan ser modificadas
const EDAD_MINIMA = 18
const EDAD_MAXIMA = 99

// Pido al usuario que ingrese su edad y lo convierto a nro entero
let edad = parseInt(prompt('Ingrese su edad: '))

// Valido la edad 
if (edad > EDAD_MINIMA && edad < EDAD_MAXIMA)
    // Muestro el mensaje si esta dentro del rango permitido
    console.log('Esta dentro de la edad permitida')
else
